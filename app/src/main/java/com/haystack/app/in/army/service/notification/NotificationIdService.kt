package com.haystack.app.`in`.army.service.notification
...
import com.haystack.app.`in`.army.utils.AppConstants.NOTIFICATION_CHANNEL_ID
import com.haystack.app.`in`.army.utils.AppConstants.NOTIFICATION_ID
import com.haystack.app.`in`.army.view.activity.MainMenuActivity

class NotificationIdService: FirebaseMessagingService() {


    override fun onNewToken(token: String) {
        super.onNewToken(token)
        SessionManager.instance.saveUserFbToken(token)
