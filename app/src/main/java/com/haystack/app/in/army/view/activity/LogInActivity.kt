...
import com.haystack.app.`in`.army.databinding.ActivityLoginBinding
                    ...
                    try {
                        ...
                        if (response.isSuccessful){
                            if (response.body()!!.status == "1"){
                                ...
                                com.haystack.app.`in`.army.manager.SessionManager.instance.saveUserCredentials(response.body()!!)
